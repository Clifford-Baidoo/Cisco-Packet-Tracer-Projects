...
### Main Campus
- **Core/Distribution Device**: Multilayer Switch (e.g., 3560-24PS)  
  - Performs inter-VLAN routing, DHCP, and RIP participation
- **Access Layer**: Three Layer 2 switches (e.g., 2960) for Buildings A, B, and C  
...
- **Cloud-PT** device acting as WAN bridge
...
|------|-------------------|--------------------|----------------------|-------------------|-----------|
| 10   | Building A        | 172.12.155.0/27    | .1 – .30             | 172.12.155.1      | VLAN10    |
| 20   | Building B        | 172.12.155.32/27   | .33 – .62            | 172.12.155.33     | VLAN20    |
| 30   | Building C        | 172.12.155.64/27   | .65 – .94            | 172.12.155.65     | VLAN30    |
| 40   | Administration    | 172.12.155.96/27   | .97 – .126           | 172.12.155.97     | VLAN40    |
| 50   | IT / Servers      | 172.12.155.128/27  | .129 – .158          | 172.12.155.129    | VLAN50    |
| 60   | Teachers          | 172.12.155.160/27  | .161 – .190          | 172.12.155.161    | VLAN60    |
| 70   | Students          | 172.12.155.192/27  | .193 – .222          | 172.12.155.193    | VLAN70    |
| 80   | Guests            | 172.12.155.224/27  | .225 – .254          | 172.12.155.225    | VLAN80    |

### Server Static IPs (in VLAN50 – IT)
- DNS Server: `172.12.155.140`
- FTP Server: `172.12.155.141`
- Web Server: `172.12.155.145`

### Point-to-Point Routed Links (/30)
- Main L3 Switch ↔ Main Router: `10.0.0.0/30`
- Branch L3 Switch ↔ Branch Router: `172.16.1.0/30`
- Cloud Router ↔ Main Router: `10.0.1.0/30`
- Main Router ↔ Branch Router: `10.0.2.0/30`

### External Email Network
- Network: `20.0.0.0/30`
- Email Server: `20.0.0.1`
- Cloud Router interface: `20.0.0.2`
...
- DNS service enabled
- Records:
  - `www.myschool.edu` → 172.12.155.145 (Web)
  - `ftp.myschool.edu` → 172.12.155.141 (FTP)
  - `mail.myschool.edu` → 20.0.0.1 (Email)
  - MX record for `myschool.edu`

#### FTP Server (172.12.155.141)
- FTP service enabled
- Users configured (student, teacher, anonymous)
